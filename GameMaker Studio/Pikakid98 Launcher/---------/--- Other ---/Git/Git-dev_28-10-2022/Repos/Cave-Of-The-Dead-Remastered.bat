...
cd "Data\Cave Of The Dead Remastered\v0.1.1"

START /wait "" "Cave Of The Dead Remastered v0.1.1.exe"
...
:Extract
Util\7zr.exe x "%tmp%\PL-Temp\Cave.Of.The.Dead.Remastered.V0.1.1.Alpha.7z" -o"Data\Cave Of The Dead Remastered\v0.1.1"
