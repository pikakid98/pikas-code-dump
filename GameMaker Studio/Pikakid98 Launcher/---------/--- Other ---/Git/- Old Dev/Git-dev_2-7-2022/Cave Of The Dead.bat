...
:Check-NP
if exist "%userprofile%\Documents\Pikakid98 Launcher\Cave Of The Dead\v1.3.0.1\Cave Of The Dead (v1.3.0.1).exe" (
    GOTO Installed
) else (
    GOTO NotInstalled
)
...
START "" "%userprofile%\Documents\Pikakid98 Launcher\Cave Of The Dead\v1.3.0.1\Cave Of The Dead (v1.3.0.1).exe"
exit

:Installed-P
;Title [Launching] Cave Of The Dead (v1.3.0.1)

START "" "Data\Cave Of The Dead\v1.3.0.1\Cave Of The Dead (v1.3.0.1).exe"
exit
::----------------------------------------------------------
...
mkdir "%userprofile%\Documents\Pikakid98 Launcher\Cave Of The Dead\v1.3.0.1"
GOTO Extract-NP
)

:Extract-NP
7za.exe x "%tmp%\PL-Temp\Cave.Of.The.Dead.v1.3.0.1.7z" -o"%userprofile%\Documents\Pikakid98 Launcher\Cave Of The Dead\v1.3.0.1"
GOTO End

:Extract-P
7za.exe x "%tmp%\PL-Temp\Cave.Of.The.Dead.v1.3.0.1.7z" -o"Data\Cave Of The Dead\v1.3.0.1"
GOTO End
