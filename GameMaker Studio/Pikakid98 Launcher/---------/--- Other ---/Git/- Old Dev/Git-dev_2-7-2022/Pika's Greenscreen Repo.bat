@ECHO OFF
if exist "%userprofile%\Documents\Pikakid98 Launcher\Pika's Greenscreen Repo\8-6-2022 @ 2-25 AM\Pika's Greenscreen Repo.m3u" (
    GOTO Installed
) else (
    GOTO NotInstalled
)
...
::----------------------------------------------------------
:Installed
;Title [Launching] Pika's Greenscreen Repo (8-6-2022 @ 2-25 AM)

START "" "%userprofile%\Documents\Pikakid98 Launcher\Pika's Greenscreen Repo\8-6-2022 @ 2-25 AM\Pika's Greenscreen Repo.m3u"
exit
::----------------------------------------------------------

::----------------------------------------------------------
:NotInstalled
;Title [Downloading] Pika's Greenscreen Repo (8-6-2022 @ 2-25 AM)
...
7za.exe x "%tmp%\PL-Temp\All.7z" -o"%userprofile%\Documents\Pikakid98 Launcher\Pika's Greenscreen Repo\8-6-2022 @ 2-25 AM"
