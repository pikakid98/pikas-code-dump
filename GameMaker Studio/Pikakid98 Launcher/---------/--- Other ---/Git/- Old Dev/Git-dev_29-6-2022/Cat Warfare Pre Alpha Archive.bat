...
:Check-P
if exist "Data\Cat Warfare Pre-Alpha Archive\Launcher\v1.0.1\Cat Warfare Pre-Alpha Archive Launcher.exe" (
    GOTO Installed-P
) else (
    GOTO NotInstalled
)
...
:Check-NP
if exist "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\Launcher\v1.0.1\Cat Warfare Pre-Alpha Archive Launcher.exe" (
    GOTO Installed
) else (
    GOTO NotInstalled
)
...
::----------------------------------------------------------
:Installed
;Title [Launching] Cat Warfare Pre-Alpha Archive (Launcher_v1.0.1)

START "" "Data\Cat Warfare Pre-Alpha Archive\Launcher\v1.0.1\Cat Warfare Pre-Alpha Archive Launcher.exe"
exit
...
::----------------------------------------------------------
:NotInstalled
;Title [Downloading] Cat Warfare Pre-Alpha Archive (Launcher_v1.0.1)

mkdir "%tmp%\PL-Temp"

ECHO Set objWinHttp = CreateObject("WinHttp.WinHttpRequest.5.1") >> %tmp%\PL-Temp\dl.vbs
ECHO. >> %tmp%\PL-Temp\dl.vbs
ECHO URL = "https://github.com/Git-Pikakid98/cat-warfare-pre-alpha-archive/releases/download/Launcher_v1.0.1/Cat.Warfare.Pre-Alpha.Archive.Launcher.7z" >> %tmp%\PL-Temp\dl.vbs
...
mkdir "Data\Cat Warfare Pre-Alpha Archive\Launcher\v1.0.1"
GOTO Extract-P
)
...
mkdir "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\Launcher\v1.0.1"
GOTO Extract-NP
)

:Extract-NP
7za.exe x "%tmp%\PL-Temp\Cat.Warfare.Pre-Alpha.Archive.Launcher.7z" -o"%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\Launcher\v1.0.1"
GOTO End

:Extract-P
7za.exe x "%tmp%\PL-Temp\Cat.Warfare.Pre-Alpha.Archive.Launcher.7z" -o"Data\Cat Warfare Pre-Alpha Archive\Launcher\v1.0.1"
GOTO End
