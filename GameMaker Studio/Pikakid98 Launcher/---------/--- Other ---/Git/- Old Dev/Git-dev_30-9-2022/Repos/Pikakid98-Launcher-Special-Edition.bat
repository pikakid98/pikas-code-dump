...
cd "Data\Pikakid98 Launcher - Special Edition\v1.1"

START /wait "" "Pikakid98 Launcher - Special Edition.exe"
...
:Extract
Util\7zr.exe x "%tmp%\PL-Temp\Pikakid98.Launcher.-.Special.Edition.7z" -o"Data\Pikakid98 Launcher - Special Edition\v1.1"
GOTO End
