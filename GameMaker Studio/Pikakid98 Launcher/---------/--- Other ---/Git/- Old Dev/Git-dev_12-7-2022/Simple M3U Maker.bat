...
START "" "Data\Simple M3U Maker\v2.2.2\Simple M3U Maker (v2.2.2).exe"
exit
::----------------------------------------------------------
...
mkdir "%userprofile%\Documents\Pikakid98 Launcher\Simple M3U Maker\v2.2.2"
GOTO Extract-NP
)
...
:Extract-P
7za.exe x "%tmp%\PL-Temp\Simple.M3U.Maker.v2.2.2.7z" -o"Data\Simple M3U Maker\v2.2.2"
GOTO End
