...
START "" "Data\Cat Warfare Skin Creator\v1.0\CatWarfare Skin Creator.exe"
exit
::----------------------------------------------------------
...
mkdir "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Skin Creator\v1.0"
GOTO Extract-NP
)
...
:Extract-P
7za.exe x "%tmp%\PL-Temp\Cat.Warfare.Skin.Creator.V1.0.0.Beta.7z" -o"Data\Cat Warfare Skin Creator\v1.0"
GOTO End
