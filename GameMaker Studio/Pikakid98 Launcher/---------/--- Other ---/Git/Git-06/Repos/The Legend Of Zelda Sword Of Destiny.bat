...
START "" "The Legend Of Zelda Sword Of Destiny (v1.1).exe"
exit
::----------------------------------------------------------
...
:Extract
7zr.exe x "%tmp%\PL-Temp\The.Legend.Of.Zelda.Sword.Of.Destiny.v1.1.7z" -o"Data\The Legend Of Zelda - Sword Of Destiny\v1.1"
GOTO End
