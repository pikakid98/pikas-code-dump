...
::----------------------------------------------------------
:Installed
;Title [Launching] Pika's Greenscreen Repo (v14)
...
::----------------------------------------------------------
:NotInstalled
;Title [Downloading] Pika's Greenscreen Repo (v14)
...
7za.exe x "%tmp%\PL-Temp\All.7z" -o"%userprofile%\Documents\Pikakid98 Launcher\Pika's Greenscreen Repo\v14"
