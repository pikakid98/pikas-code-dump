@ECHO OFF
if exist "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\Launcher\v1.2\Cat Warfare Pre-Alpha Archive Launcher.exe" (
    GOTO Installed
) else (
    GOTO NotInstalled
)
...
START "" "%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\Launcher\v1.2\Cat Warfare Pre-Alpha Archive Launcher.exe"
exit
::----------------------------------------------------------
...
7za.exe x "%tmp%\PL-Temp\Cat.Warfare.Pre-Alpha.Archive.Launcher.7z" -o"%userprofile%\Documents\Pikakid98 Launcher\Cat Warfare Pre-Alpha Archive\Launcher\v1.2"
