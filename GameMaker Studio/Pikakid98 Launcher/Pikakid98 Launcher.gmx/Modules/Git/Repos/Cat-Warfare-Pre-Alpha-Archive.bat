...
cd "Data\Cat Warfare Pre-Alpha Archive\Launcher\v1.2"

START /wait "" "Cat Warfare Pre-Alpha Archive Launcher.exe"
...
:Extract
Util\7zr.exe x "%tmp%\PL-Temp\Cat.Warfare.Pre-Alpha.Archive.Launcher.7z" -o"Data\Cat Warfare Pre-Alpha Archive\Launcher\v1.2"
GOTO End
